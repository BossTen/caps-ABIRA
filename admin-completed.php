  ...
  <table id='table' class="table table-striped">
    <thead>
      ...
      require '../api/dbcon.php';
                                                        ...
                                                        $stmt = $conn->prepare("SELECT j.SerialCode,j.Campus, j.UserJobDescription, j.JobRecommendation, j.DateRequestCreated, j.statusId, s.name as statusName FROM joborder as j  INNER JOIN status as s ON j.statusId = s.Id WHERE j.Campus = ? && (statusId = 6)");

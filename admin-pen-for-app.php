...
<head>
    ...
    <title>Job Order Pending for Approval View</title>
  <meta charset="utf-8">
...
<div class="container">
   <div class="form-row">
      <div class="col-5 w3-text-red"><h1>Job Order<br>Pending For Approval<br> Records</h1></div>

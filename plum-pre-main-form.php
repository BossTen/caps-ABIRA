        ...
        <div class="card">
            ...
            <h2>PLUMBING SYSTEM (Main II)</h2>
             ...
             <div class="row "><h4 class="col-6"><b>Work:</b>&nbsp;
              <input type="text" value="PLUMBING" id="plumbing" class="form-control col-12" disabled></h4>
        ...
        <div class="row">
                            ...
                            <div class="row">
                             <h4 class="col-6"><b>Type:</b>&nbsp;<select class="form-control form-control" name="" id="campus">
                              <option value="">Water Closet</option>
                              <option value="">Faucet Bibb</option>	
                              <option value="">Lavatory</option>
                              <option value="">Urinal</option>
                              <option value="">Floor Drain</option>

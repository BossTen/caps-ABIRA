...
$sql = "SELECT * FROM preventive_maintenance WHERE work LIKE 'Generator%' AND campus LIKE 'Alangilan%'";
...
$sql="SELECT * FROM preventive_maintenance WHERE work LIKE 'Generator%' AND campus LIKE 'Alangilan%' Order by id DESC  LIMIT " . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($conn, $sql);
...
for ($page=1;$page<=$number_of_pages;$page++) {
    echo '<li class="page-item"><a class="page-link" href="gsfc-pre-main-view.php?page=' . $page . '">' . $page . '</a> ';

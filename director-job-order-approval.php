            ...
            <div class="card">
                <div class="card-body" style="margin-left:2%;">
                    ...
                    <table class="table table-bordered w3-card w3-round">
                        ...
                        <br>
                        <tr>
                            <th id="con-startDate">Date: <input type="hidden" name="start-of-service" onchange="serviceCheckDate()" class="form-control" id="startOfService" value="<?php echo $StartOfService; ?>" readonly></th>
                            <th><input type="hidden" name="end-of-service" onchange="serviceCheckDate()" class="form-control" id="endOfService" readonly></th>
                            <th id="con-numhours" rowspan=2 value="<?php echo $EndOfService; ?>"><input class="w3-input" type="hidden" name="no-of-hours" id="noOfHours" value="<?php echo $NoOfHours; ?>" readonly>
                        ...
                        <tr>
                            <th>Time:<input type="hidden" class="form-control" name="start-of-service-time" onchange="serviceCheckDate()" id="startOfServiceTime" value="<?php echo $StartOfServiceTime;?>" readonly></th>
                            <th><input type="hidden" class="form-control" name="end-of-service-time" onchange="serviceCheckDate()" id="endOfServiceTime" value="<?php echo $EndOfServiceTime; ?>" readonly></th>
                    ...
                    <table class="table table-bordered w3-card w3-round">
                        ...
                        <tr>
                            ...
                            <th><medium><?php echo  $RequestorName; ?></medium></th>
                            <th><input class="w3-input" type="hidden" name="conforme-signature" readonly></th>
                            <th>
                                <center><input type="hidden" class="form-control" name="conforme-date-signed" value="<?php echo $ConformeDateApproved?>" readonly>
                            </th>
                        </tr>
                        <tr>
                            <th>

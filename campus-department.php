...
<img src="batlogo.png" alt="logo" width="100px" height="100px">CIT</a>
  ...
  <div class="row">
    <div class="col w3-center">
      <a href="" type="button" class="btn btn-default w3-xxlarge w3-white w3-border-red">
<img src="batlogo.png" alt="logo" width="100px" height="100px">RGR</a>
    </div>
    <div class="col">
      <a href="" type="button" class="btn btn-default w3-xxlarge w3-white w3-border-red">
<img src="batlogo.png" alt="logo" width="100px" height="100px">SSC</a>
    </div>
    <div class="col">
      <a href="" type="button" class="btn btn-default w3-xxlarge w3-white w3-border-red">
<img src="batlogo.png" alt="logo" width="100px" height="100px">SFIHM</a>
    </div>
  </div><br>
  <div class="row">
    <div class="col w3-center">
      <a href="" type="button" class="btn btn-default w3-large w3-white w3-border-red">
<img src="batlogo.png" alt="logo" width="100px" height="100px">Gymnasium Area</a>
    </div>
    <div class="col">
      <a href="" type="button" class="btn btn-default w3-large w3-white w3-border-red">
<img src="batlogo.png" alt="logo" width="100px" height="100px">Food Innovation Center Building</a>
    </div>
    <div class="col">
      <a href="" type="button" class="btn btn-default w3-large w3-white w3-border-red">
<img src="batlogo.png" alt="logo" width="100px" height="100px">FMSO/GSO Office</a>
    </div>
  </div>
</div>

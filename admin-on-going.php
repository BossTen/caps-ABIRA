...
<head>
    ...
    <title>Job Order On-Going View</title>
  <meta charset="utf-8">
...
<div class="container">
   <div class="form-row">
      <div class="col-5 w3-text-red"><h1>Job Order<br>On-Going Records</h1></div>
  ...
  <table id='table' class="table table-striped">
    ...
    <tbody>
      ...
      require '../api/dbcon.php';
                                                        ...
                                                        $stmt = $conn->prepare("SELECT j.SerialCode,j.Campus, j.UserJobDescription, j.JobRecommendation, j.DateRequestCreated, j.statusId, s.name as statusName FROM joborder as j  INNER JOIN status as s ON j.statusId = s.Id WHERE j.Campus = ? && (statusId = 5)");

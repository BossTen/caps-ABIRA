...
// ANS: '20:35:00'
 ...
 $noOfSeconds=abs((strtotime($startOfService)+strtotime($startOfServiceTime))-(strtotime($endOfService)+strtotime($endOfServiceTime)));
 $noOfMinutes= $noOfSeconds/60;
...
<head>
  <title>Print Job Order Approved</title>
  <meta charset="utf-8">
